...
class ReportBookings(models.Model):
    _name = "report.bookings"
    ...
    def create(self, vals):
        ...
        if unique_id and self.search([("unique_id", "=", unique_id)]):
            return False  # Prevent creating a duplicate record
